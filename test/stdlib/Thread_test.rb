...
require File.expand_path(File.dirname(__FILE__) + "/../../tool/lib/envutil")
require File.expand_path(File.dirname(__FILE__) + "/../../tool/lib/test/unit")
require File.expand_path(File.dirname(__FILE__) + "/../../tool/lib/test/unit/assertions")
require File.expand_path(File.dirname(__FILE__) + "/../../tool/lib/test/unit/core_assertions")
require "test/unit"

class TestThread < StdlibTest
